...
Do **not** edit files under `vendor/ragflow-docker/` except to refresh the pin. Overlay, env, PaddleOCR, MinerU API, and Claimprint UI defaults (MinerU parser, Groq chat) live outside `vendor/`.
