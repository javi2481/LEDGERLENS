...
> **Change activo (producto).** No inflar [`claimprint-idp-kernel`](../claimprint-idp-kernel/), [`claimprint-finance-pnl-claims`](../claimprint-finance-pnl-claims/), ni el pin [`claimprint-ragflow`](../claimprint-ragflow/).
