...
Do **not** edit files under `vendor/ragflow-docker/` except to refresh the pin. Overlay, env, PaddleOCR, Docling Serve, and LedgerLens UI defaults (Docling parser, OpenRouter) live outside `vendor/`.
