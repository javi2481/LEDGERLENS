...
- THEN both MUST name `claimprint-product-shape`
- AND `claimprint-mineru-parse` MUST be listed as shipped, not activo
- AND `claimprint-ragflow` MUST remain the UI/stack pin (do not inflate)
