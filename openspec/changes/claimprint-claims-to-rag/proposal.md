...
> **Change activo (producto).** No inflar shipped kernel/P&L/press/mineru-parse, [`claimprint-product-shape`](../claimprint-product-shape/), ni el pin [`claimprint-ragflow`](../claimprint-ragflow/).
