...
**Decisión (2026-08-16, overlay):** Docling Graph entra al demo: extrae fichas y `push_hechos_to_demo4.py` las inyecta en `chat_demo_4` (chunk manual, sin reparsear PDFs MinerU).
