...
| **Proxy LiteLLM (sidecar Compose)** | Innecesario para este demo: RAGFlow ya elige Gemini / Ollama / Voyage en Model providers. El hop extra no aportaba. OpenRouter sigue fuera. El SDK LiteLLM de Docling Graph **no** es este sidecar y sigue en agenda. |
