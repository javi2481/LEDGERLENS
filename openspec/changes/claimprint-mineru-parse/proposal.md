...
> **Change activo (producto).** No inflar [`claimprint-idp-kernel`](../claimprint-idp-kernel/), [`claimprint-finance-pnl-claims`](../claimprint-finance-pnl-claims/), [`claimprint-claim-store`](../claimprint-claim-store/), [`claimprint-press-release`](../claimprint-press-release/), ni el pin [`claimprint-ragflow`](../claimprint-ragflow/).
...
- [x] `claimprint-ragflow` unchanged
