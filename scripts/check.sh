...
[[ -f docs/cierre-academico.md ]] || fail "missing docs/cierre-academico.md"
[[ -f openspec/changes/ledgerlens-academic-close/proposal.md ]] || fail "missing academic-close proposal"
[[ -f openspec/changes/ledgerlens-press-ltm/proposal.md ]] || fail "missing press-ltm proposal"
[[ -f openspec/changes/ledgerlens-rag-pilot/proposal.md ]] || fail "missing rag-pilot proposal"
