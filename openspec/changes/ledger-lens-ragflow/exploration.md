...
> Histórico del bootstrap (árbol vacío + fixtures sintéticos). El change **aplicado** es MinerU `pipeline` + corpus BYMA en `docs/archivos_muestra/` + chat Gemini. No usar este archivo como fuente de verdad del demo.
