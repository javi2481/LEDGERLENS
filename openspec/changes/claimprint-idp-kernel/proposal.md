...
> **Shipped.** El change activo de producto es [`claimprint-finance-pnl-claims`](../claimprint-finance-pnl-claims/). El pin del demo RAGFlow está congelado en [`claimprint-ragflow`](../claimprint-ragflow/).
