...
> **Change activo (producto).** No inflar kernel, plugins, academic-close, press-ltm, ni el pin [`ledger-lens-ragflow`](../ledger-lens-ragflow/). Do not fatten [`scripts/push_claims.py`](../../../scripts/push_claims.py).
