...
Docs and catalog only. No extract/lookup behavior change. Graph overlay files stay on disk until `ledgerlens-claims-to-rag`.
...
| File | Action |
|------|--------|
| `openspec/changes/ledgerlens-product-shape/` | Create SDD |
